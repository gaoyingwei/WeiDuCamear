...
public class FirstAdapter extends RecyclerView.Adapter<FirstAdapter.Holder>{
    ...
    public FirstAdapter(List<Baner> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=LayoutInflater.from(context).inflate(R.layout.item_hot_adapter,null);
    ...
    public class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(View itemView) {
            super(itemView);
            simpleDraweeView=itemView.findViewById(R.id.sims);
            textView_name=itemView.findViewById(R.id.names);
            textView_title=itemView.findViewById(R.id.titles);
            imageView=itemView.findViewById(R.id.guan);
        }
    }
}
